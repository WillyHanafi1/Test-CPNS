  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <section className="pt-40 pb-20 border-t border-slate-800/50">
        ...
        {/* Grand Developer Footer (Bottom) */}
        <div className="relative mt-20 border-t border-slate-900/50">
          <div className="absolute inset-0 bg-gradient-to-b from-indigo-500/0 via-indigo-500/2 to-indigo-500/5 pointer-events-none" />
          <MagicBento />
        </div>
      </main>
